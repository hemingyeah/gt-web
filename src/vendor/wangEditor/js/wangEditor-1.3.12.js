                    ...
                    if (result.indexOf('ok|') === 0) {
                        ...
                        if (arr.length === 2) {
                            ...
                            if (title === '') {
                                ...
                                editor.command(e, 'customeInsertImage', {
                                    'url': url,
                                    'title': title
                                }, uploadImg_callback);
                            }
            ...
            editor.menus = {
                        ...
                        $link_modal.find('#' + btnId).click(function(e) {
                            ...
                            if (url !== '') {
                                ...
                                if (hasSelectContent === false) {
                                    ...
                                    editor.command(e, 'customCreateLink', {
                                        'url': url,
                                        'title': title,
                                        'isBlank': isBlank
                                    }, link_callback);
                ...
                'insertImage': {
                    ...
                    'modal': function(editor) {
                        ...
                        // var content = "";
                        var content = '<p>' +
                            '   <span id="' + alertInfoId + '">' + langInsertLocal + '</span> ' +
                            '  <input type="file" id="files"/ style="margin: 20px;">' +
                            '</p>' ,
